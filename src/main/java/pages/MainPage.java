...
public class MainPage {
    ...
    public MessagePage goToMessage() {
        mainToolbar.getMessageButton()
                .shouldBe(visible.because("The message button should be visible before clicking")).click();
        return new MessagePage();
    }

    public void logout() {
        mainToolbar.getProfileSettingsButton()
                .shouldBe(visible.because("The profile settings button should be visible before clicking")).click();
